# -*- coding: utf-8 -*-
#
# TARGET arch is: ['-target', 'aarch64', '', '-I/opt/hisi-linux/x86-arm/aarch64-himix100-linux/host_bin/../lib/gcc/aarch64-linux-gnu/6.3.0/include', '-I/opt/hisi-linux/x86-arm/aarch64-himix100-linux/host_bin/../lib/gcc/aarch64-linux-gnu/6.3.0/include-fixed', '-I/opt/hisi-linux/x86-arm/aarch64-himix100-linux/host_bin/../lib/gcc/aarch64-linux-gnu/6.3.0/../../../../aarch64-linux-gnu/include', '-I/opt/hisi-linux/x86-arm/aarch64-himix100-linux/host_bin/../target/usr/include', '-I/data/jenkins/jobs/anafi2-airsdk-release/workspace/out/anafi2-classic_airsdk/build/libpomp', '-I/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/libpomp', '-I/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/ulog/libulog/include', '-I/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/libpomp/include', '-I/data/jenkins/jobs/anafi2-airsdk-release/workspace/out/anafi2-classic_airsdk/staging/usr/include/aarch64-linux-gnu', '-I/data/jenkins/jobs/anafi2-airsdk-release/workspace/out/anafi2-classic_airsdk/staging/usr/include', '-pipe', '-O2', '-g', '-ffunction-sections', '-DALCHEMY_BUILD', '-fPIC', '-funwind-tables', '-fvisibility=hidden', '-DPOMP_API_EXPORTS', '-DBUILD_LIBULOG', '-D__PYBINDING_MACRO__=1', '-fno-unsigned-char', '']
# WORD_SIZE is: 8
# POINTER_SIZE is: 8
...
__all__ = \
    ...
    'size_t', 'struct___va_list', 'struct_pomp_buffer',
