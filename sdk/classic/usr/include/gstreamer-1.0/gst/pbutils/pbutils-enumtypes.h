...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/pbutils/install-plugins.h" */

GType gst_install_plugins_return_get_type (void);
#define GST_TYPE_INSTALL_PLUGINS_RETURN (gst_install_plugins_return_get_type())

/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/pbutils/gstdiscoverer.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/pbutils/gstaudiovisualizer.h" */
