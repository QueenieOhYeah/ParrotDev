...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/rtsp/gstrtsptransport.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/rtsp/gstrtspmessage.h" */

GType gst_rtsp_msg_type_get_type (void);
#define GST_TYPE_RTSP_MSG_TYPE (gst_rtsp_msg_type_get_type())

/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/rtsp/gstrtspdefs.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/rtsp/gstrtsprange.h" */
