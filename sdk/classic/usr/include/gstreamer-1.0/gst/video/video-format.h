 ...
 * @GST_VIDEO_FORMAT_NV21_10BE: planar 4:2:0 YUV with interleaved VU plane, 10 bits per channel (Since: 1.18)
 * @GST_VIDEO_FORMAT_NV21_10LE: planar 4:2:0 YUV with interleaved VU plane, 10 bits per channel (Since: 1.18)
...
typedef enum {
  ...
  GST_VIDEO_FORMAT_NV21_10BE,
  GST_VIDEO_FORMAT_NV21_10LE,
} GstVideoFormat;
...
#define GST_VIDEO_FORMATS_ALL "{ I420, YV12, YUY2, UYVY, AYUV, RGBx, "  \
  ...
  "Y444_12BE, Y444_12LE, NV21_10BE, NV21_10LE }"
