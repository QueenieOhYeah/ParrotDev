...
/**
 * GST_TAG_GEO_LOCATION_MAP_DATUM:
 *
 * Indicates the geodetic survey data used by the GPS receiver.
 * If the survey data is restricted to Japan, the value of this tag
 * is "TOKYO" or "WGS-84".
 */
#define GST_TAG_GEO_LOCATION_MAP_DATUM            "geo-location-map-datum"
/**
 * GST_TAG_SHOW_NAME:
 *
 ...
 *
 * Vehicle ID of the media (string)
 */
 ...
 * GST_TAG_BOOT_DATE:
 *
 * Boot date of the media, ISO 8601 (GST_TYPE_DATE_TIME)
 */
#define GST_TAG_BOOT_DATE                             "boot-date"
 ...
 * GST_TAG_FLIGHT_DATE:
 *
 * Flight date of the media, ISO 8601 (GST_TYPE_DATE_TIME)
 */
#define GST_TAG_FLIGHT_DATE                           "flight-date"

/**
 * GST_TAG_CUSTOM_ID:
 *
 * Custom ID of the media (string)
 */
#define GST_TAG_CUSTOM_ID                             "custom-id"

/**
 * GST_TAG_CAMERA_TYPE:
 *
 * Tells the camera type (string)
 */
#define GST_TAG_CAMERA_TYPE                           "camera-type"

/**
 * GST_TAG_VIDEO_MODE:
 *
 * Tells in which mode the video has been captured (string)
 *
 * Allowed values:
 *   "Standard"
 *   "Hyperlapse"
 *   "SlowMotion"
 */
#define GST_TAG_VIDEO_MODE                            "video-mode"

/**
 *  GST_TAG_STOP_REASON
 *
 * Tells the recording stop reason (string)
 */
#define GST_TAG_STOP_REASON                           "stop-reason"

/**
 *  GST_TAG_DYNAMIC_RANGE
 *
 * Image dynamic range (string)
 */
#define GST_TAG_DYNAMIC_RANGE                         "dynamic-range"

/**
 *  GST_TAG_TONE_MAPPING
 *
 * Image tone mapping (string)
 */
#define GST_TAG_TONE_MAPPING                          "tone-mapping"
...
/**
 * GST_TAG_STEREO_CALIBRATION:
 *
 * Stereo calibration data (string)
 */
#define GST_TAG_STEREO_CALIBRATION "stereo-calibration"

/**
 * GST_TAG_STEREO_CORRECTION:
 *
 * Stereo correction data (string)
 */
#define GST_TAG_STEREO_CORRECTION "stereo-correction"

/**
 * GST_TAG_FCR_PIPELINE:
 *
 * Pipeline of the FCR image (string)
 */
#define GST_TAG_FCR_PIPELINE "fcr-pipeline"

/**
 * GST_TAG_FCR_METADATA:
 *
 * Specific metadata the FCR image formated as json (string)
 */
#define GST_TAG_FCR_METADATA "fcr-metadata"

/**
 * GST_TAG_AUTOPILOT_MISSION:
 *
 * tells the current autopilot mission (string)
 */
#define GST_TAG_AUTOPILOT_MISSION "autopilot-mission"

/**
 * GST_TAG_AUTOPILOT_STATE:
 *
 * tells the current autopilot state (string)
 */
#define GST_TAG_AUTOPILOT_STATE "autopilot-state"
