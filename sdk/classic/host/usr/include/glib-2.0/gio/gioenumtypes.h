...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/glib/gio/gioenums.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/glib/gio/gsettings.h" */
