...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gstreamer/libs/gst/controller/gstinterpolationcontrolsource.h" */

GType gst_interpolation_mode_get_type (void);
#define GST_TYPE_INTERPOLATION_MODE (gst_interpolation_mode_get_type())

/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gstreamer/libs/gst/controller/gstlfocontrolsource.h" */
