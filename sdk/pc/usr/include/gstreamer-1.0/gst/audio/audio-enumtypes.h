...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/audio-format.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/audio-channels.h" */

GType gst_audio_channel_position_get_type (void);
#define GST_TYPE_AUDIO_CHANNEL_POSITION (gst_audio_channel_position_get_type())

/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/audio-channel-mixer.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/audio-converter.h" */

GType gst_audio_converter_flags_get_type (void);
#define GST_TYPE_AUDIO_CONVERTER_FLAGS (gst_audio_converter_flags_get_type())

/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/audio-info.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/audio-quantize.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/audio-resampler.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/gstaudioringbuffer.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/gstaudiobasesrc.h" */
...
/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/gstaudiocdsrc.h" */

GType gst_audio_cd_src_mode_get_type (void);
#define GST_TYPE_AUDIO_CD_SRC_MODE (gst_audio_cd_src_mode_get_type())

/* enumerations from "/data/jenkins/jobs/anafi2-airsdk-release/workspace/packages/gst-plugins-base/gst-libs/gst/audio/gstaudiobasesink.h" */
