...
ifneq ("$(TARGET_OS_FLAVOUR)","native-chroot")
  $(error This sdk is for TARGET_OS_FLAVOUR=native-chroot)
endif
...
ifneq ("$(TARGET_TOOLCHAIN_TRIPLET)","x86_64-linux-gnu")
  $(error This sdk is for TARGET_TOOLCHAIN_TRIPLET=x86_64-linux-gnu)
endif

ifneq ("$(TARGET_LIBC)","native")
  $(error This sdk is for TARGET_LIBC=native)
endif

ifeq ("$(call check-version,9,$(TARGET_CC_VERSION))","")
  $(error This sdk is for TARGET_CC_VERSION <= 9)
endif
...
LOCAL_EXPORT_LDLIBS := \
	...
	-lgstgl-1.0
LOCAL_EXPORT_C_INCLUDES := \
	$(LOCAL_PATH)/usr/lib/gstreamer-1.0/include
